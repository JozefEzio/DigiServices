  ...
  const teamMembers = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1766066014237-00645c74e9c6?w=400',
    },
    {
      name: 'Youssef Zouileg',
      role: 'Développeur Full Stack',
      image: 'https://images.unsplash.com/photo-1752859951149-7d3fc700a7ec?w=400',
    },
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-gray-700">
            <p>
              DigiServices est une entreprise IT basée à Casablanca avec 200 employés. Face à un volume croissant de 
